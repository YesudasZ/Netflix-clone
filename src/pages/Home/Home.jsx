...
import TitileCard from "../../components/TitileCards/TitileCard";
    ...
    <div className="home">
      ...
      <div className="hero">
        ...
        <div className="hero-caption">
          ...
          <p>
            Discovering his ties to a secret ancient order, a young man livig in
      ...
      <TitileCard title={"Top Pics for You"} category={"popular"}/>
      </div>
      <Footer/>
    </div>
  );
